...
module.exports = {
    Get_Nlp_Flow9: function (callbacks) {
        if (callbacks.message.toLowerCase() == "1. check my browser." || callbacks.message.toLowerCase().includes("check browser")) {
            console.log("Matched............. ");
            var obj = {};
            obj.result = {};
            obj.result.parameters = {};
            obj.result.metadata = {};
            obj.result.metadata.intentName = "CheckBrowser";
            callbacks.match(obj);
        }
        else if (callbacks.message.toLowerCase() == "2. return to help topics." || callbacks.message.toLowerCase().includes("return to help")) {
            var obj = {};
            obj.result = {};
            obj.result.parameters = {};
            obj.result.metadata = {};
        ...
        // put else if for all possible options
            ...
            app.sendToapiai(callbacks.session, callbacks.message,
                function (response) {
                    if (response.queryResult.intent.displayName == "CheckBrowser") {
                        var obj = {};
                        obj.result = {};
                        obj.result.parameters = {};
                        obj.result.metadata = {};
