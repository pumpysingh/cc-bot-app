...
module.exports = {
    Get_Nlp_Flow5_End: function (callbacks) {
        console.log("callbackscallbacks", callbacks.message);
        if((callbacks.message.toLowerCase() == "1. yes, return to help topics." || callbacks.message.toLowerCase().includes("yes return"))|| callbacks.message.toLowerCase().includes("help topics")) {
            console.log("Matched............. ");
            var obj = {};
            obj.result = {};
        ...
        else if ((callbacks.message.toLowerCase() == "2. no, end chat." || callbacks.message.toLowerCase().includes("end chat"))|| callbacks.message.toLowerCase().includes("chat end")) {
            var obj = {};
            obj.result = {};
            obj.result.parameters = {};
            obj.result.metadata = {};
