...
module.exports = {
    Get_Nlp_Flow10_1_1_2: function (callbacks) {
        if (callbacks.message.toLowerCase() == "1. contact nelnet campus commerce." || callbacks.message.toLowerCase().includes("contact")) {
            console.log("Matched............. ");
            var obj = {};
            obj.result = {};
