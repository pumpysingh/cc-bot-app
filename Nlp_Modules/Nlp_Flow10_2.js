...
module.exports = {
    Get_Nlp_Flow10_2: function (callbacks) {
        ...
        else if (callbacks.message.toLowerCase() == "9. adjust my payment plan balance." || callbacks.message.toLowerCase().includes("adjust my payment plan")) {
            var obj = {};
            obj.result = {};
            obj.result.parameters = {};
            obj.result.metadata = {};
