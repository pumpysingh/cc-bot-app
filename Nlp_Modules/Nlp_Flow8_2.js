...
module.exports = {
    Get_Nlp_Flow8_2: function (callbacks) {
        if (callbacks.message.toLowerCase() == "1. return to help topics." || callbacks.message.toLowerCase().includes("return back"))  {
            console.log("Matched............. ");
            var obj = {};
            obj.result = {};
        ...
        else if (callbacks.message.toLowerCase() == "2. contact nelnet." || callbacks.message.toLowerCase().includes("contact nelnet")) {
            var obj = {};
            obj.result = {};
            obj.result.parameters = {};
            obj.result.metadata = {};
