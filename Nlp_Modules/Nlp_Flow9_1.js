...
module.exports = {
    Get_Nlp_Flow9_1: function (callbacks) {
        ...
        else if ((callbacks.message.toLowerCase() == "2. no, i'd like to set up a payment plan." || callbacks.message.toLowerCase().includes("no")) && !callbacks.message.toLowerCase().includes("yes")) {
            var obj = {};
            obj.result = {};
            obj.result.parameters = {};
            obj.result.metadata = {};
