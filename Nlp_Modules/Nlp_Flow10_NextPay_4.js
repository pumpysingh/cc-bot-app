...
module.exports = {
    Get_Flow10_NextPay_4: function (callbacks) {
        if (callbacks.message.toLowerCase() == "1. more payment plan topics." || callbacks.message.toLowerCase().includes("more payment plan")) {
            console.log("Matched............. ");
            var obj = {};
            obj.result = {};
        ...
        else if (callbacks.message.toLowerCase() == "2. back to help topics" || callbacks.message.toLowerCase().includes("back"))  {
            var obj = {};
            obj.result = {};
            obj.result.parameters = {};
            obj.result.metadata = {};
        ...
        else if (callbacks.message.toLowerCase() == "3. i'm all set. end chat." || callbacks.message.toLowerCase().includes("chat end"))  {
            var obj = {};
            obj.result = {};
            obj.result.parameters = {};
            obj.result.metadata = {};
