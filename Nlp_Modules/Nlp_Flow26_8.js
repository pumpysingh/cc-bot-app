...
module.exports = {
    Get_Nlp_Flow26_8: function (callbacks) {
        if (callbacks.message.toLowerCase() == "1. return to help topics." || callbacks.message.toLowerCase().includes("return")) {
            console.log("Matched............. ");
            var obj = {};
            obj.result = {};
        ...
        else if (callbacks.message.toLowerCase() == "2. end chat." || callbacks.message.toLowerCase().includes("end chat")) {
            var obj = {};
            obj.result = {};
            obj.result.parameters = {};
            obj.result.metadata = {};
